    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400">Sumá a tu pareja para compartir tarjetas y gastos</p>
        </div>
        ...
        {invited ? (
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-6 text-center space-y-4">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              Le enviamos un enlace de invitación a <b>{partnerEmail}</b> para unirse a tu Hogar.
            </p>
            <button
              onClick={() => router.push('/')}
          ...
          <form onSubmit={handleInvite} className="space-y-4">
            <div>
              <label className="block text-xs font-bold uppercase text-slate-400 mb-1.5">
                Correo de tu Pareja o Integrante
              </label>
